...
Simulation::Simulation()
    : corridor(std::vector<Vector2>{
                   Config::World::gridPoint(4.5f, 2.0f),
                   Config::World::gridPoint(9.0f, 2.0f),
                   Config::World::gridPoint(9.0f, 5.0f),
                   Config::World::gridPoint(28.0f, 5.0f),
                   Config::World::gridPoint(28.0f, 18.1f),
                   Config::World::gridPoint(18.0f, 18.1f),
                   Config::World::gridPoint(18.0f, 22.5f),
                   Config::World::gridPoint(21.0f, 22.5f),
                   Config::World::gridPoint(21.0f, 27.0f),
                   Config::World::gridPoint(12.0f, 27.0f),
                   Config::World::gridPoint(12.0f, 22.5f),
                   Config::World::gridPoint(15.0f, 22.5f),
                   Config::World::gridPoint(15.0f, 15.1f),
                   Config::World::gridPoint(25.0f, 15.1f),
                   Config::World::gridPoint(25.0f, 8.0f),
                   Config::World::gridPoint(9.0f, 8.0f),
                   Config::World::gridPoint(9.0f, 11.0f),
                   Config::World::gridPoint(4.5f, 11.0f)},
               Config::Visuals::WALL_COLOR, Config::Visuals::WALL_THICKNESS),
      spawnZone(Config::World::gridRect(4.5f, 2.0f, 4.5f, 9.0f), Config::Visuals::SPAWN_COLOR),
      targetZone(Config::World::gridRect(12.0f, 22.5f, 9.0f, 4.5f), Config::Visuals::TARGET_COLOR),
